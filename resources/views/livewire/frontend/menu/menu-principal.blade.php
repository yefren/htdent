...
<nav class="bg-white border-b border-gray-200">
  <div class="w-full text-gray-700 max-w-screen container">
    <div x-data="{ open: false }" class="flex flex-col mx-auto ax-w-screen lg:flex-row">
      ...
      <div class="contenedor_logo flex flex-row items-center justify-between px-4 py-2 w-80">
      ...
      <nav class="flex-col flex-grow hidden h-screen pb-4 lg:pb-0 lg:flex lg:justify-center lg:flex-row lg:h-auto" aria-label="Main Navigation" :class="{'flex': open, 'hidden': !open}">
        <ul class="flex flex-col flex-wrap pl-0 m-0 lg:flex-row">
                      <li class="group relative
                            block lg:px-0 xl:px-0 mr-1 py-2" x-data="{isOpen:false }" @mouseleave="isOpen = false">
                                    <a href="#" class="py-2 x-4 group-hover:bg-gray-400 group-hover:text-white" @click="isOpen = !isOpen" x-on:click.prevent="" :class="{'' : isOpen}">
                                    About
                                ...
                                <ul class="bg-gray-600 p-2" aria-label="submenu" x-show="isOpen" @click.away="isOpen = false" style="display: none;">
                                    ...
                                    <li class="group relative border-b border-white border-opacity-[0.2]">
                                        <a href="" class="py-2 text-white bg-transparent hover:text-gray-100 lg:text-sm">Sub Page</a>
                                    </li>
                                    <li class="group relative  border-b border-white border-opacity-[0.2]" x-data="{isOpen:false }" @mouseleave="isOpen = false">
                                        <a href="#" class="py-2 text-white bg-transparent hover:text-gray-100 lg:text-sm" @click="isOpen = !isOpen" x-on:click.prevent="" :class="{'' : isOpen}">Sub Page 2</a>
                                        ...
                                        <ul class="bg-gray-600 p-2" aria-label="submenu" x-show="isOpen" @click.away="isOpen = false" style="display: none;">
                                            ...
                                            <li class="group relative border-b border-white border-opacity-[0.2]">
                                                <a href="https://craft-starter.ddev.site/pages/sub-sub-page/" class="py-2 text-white bg-transparent hover:text-gray-100 lg:text-sm">Sub Sub Page</a>
                                            </li>
                                         </ul>
                                    </li>
                        <li class="group relative border-b border-white border-opacity-[0.2]">
                            <a href="https://craft-starter.ddev.site/pages/about-2-2-2/" class="py-2 text-white bg-transparent hover:text-gray-100 lg:text-sm"> Sub Page 3</a>
                        </li>
                  </ul>

            </li>
                      <li class="group relative block lg:px-0 xl:px-0 mr-1 py-2">
                        <a href="https://craft-starter.ddev.site/pages/services/" class="py-2 px-4 group-hover:bg-gray-400 group-hover:text-white">Services</a>
                    </li>
                      <li class="group relative block lg:px-0 xl:px-0 mr-1 py-2">

              <a href="https://craft-starter.ddev.site/pages/blog/" class="py-2 px-4 group-hover:bg-gray-400 group-hover:text-white">Blog</a>
</li>
